...
complex_demo.elf: main.o float16_add.o float16_sub.o float16_mul.o float16_div.o complex_add.o complex_sub.o complex_mul.o
	avr-ld -e init -o complex_demo.elf main.o float16_add.o float16_sub.o float16_mul.o float16_div.o complex_add.o complex_sub.o complex_mul.o
main.o: main.c
